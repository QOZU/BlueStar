...
#[derive(Debug)]
pub struct BlueStarProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlueStarProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlueStar processing");
    
    let mut processor = BlueStarProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlueStarProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlueStarProcessor::new(false);
